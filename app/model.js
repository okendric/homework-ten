    var _homeContent = `<div class="splash">
  ...
  <div class="home">
    <section class="hero">
      ...
      <div id="aboutButton" onclick="toAbout()" class="read-more">READ MORE</div>
    </section>
  </div>
</div>
  ...
  <div class="container">
    <div class="tripBox">
      ...
      <div class="elements">
        <h1>ISREAL</h1>
        <h3>FROM $1000</h3>
        <div id="isreal" class="learnMore">LEARN MORE</div>
      </div>
    </div>
    ...
    <div class="tripBox">
      ...
      <div class="elements">
        <h1>U.S.A</h1>
        <h3>FROM $1300</h3>
        <div id="toUSAButton" onclick="toUSA()" class="learnMore">LEARN MORE</div>
      </div>
    </div>
    ...
    <div class="tripBox">
      ...
      <div class="elements">
        <h1>AUSTRALIA</h1>
        <h3>FROM $1700</h3>
        <div id="toAUSButton" onclick="toAustralia()" class="learnMore">LEARN MORE</div>
      </div>
    </div>
    </div>
  </div>
...
<section class="booking">
  <div class="booking-wrapper">
    ...
    <p id="CheckInLabel">Check-in</p>
    <input id="CheckIn" type="date">

    <p id="CheckOutLabel">Check-out</p>
    <input id="CheckOut" type="date">
    
    <p id="Adult">Adult</p>
    <select name="" id="AdultDropbox">
    ...
    <input id="Textbox" type="text" placeholder="  message...">
  </div>
...
<input class="submit" type="submit" value="SUBMIT">
    ...
    var _toursContent = `    
    <!----HEADER IMAGE------------------------->
    <div class="headerTourList">
      <div class="text"><h1>TOURS:</h1></div>

      <img src="images/tour/tours-header.jpg" alt="" />
    </div>

    <!--------TOUR IMAGES-------------------------->
    <div class="wrapperTourList">
      <div class="tour">
        <img src="images/tour/tour-01.jpg" alt="" />
        <div class="ontop">
          <h1>ISREAL</h1>
          <div class="price">From: $1000</div>
          <div id="toIsrealButton" class="learnMore" onclick="toIsreal()">
            <p>Learn More</p>
          </div>
        </div>
      </div>
      ...
      <div class="tour">
        ...
        <div class="ontop">
          ...
          <div id="toUSAButton" onclick="toUSA()" class="learnMore">
            <p>Learn More</p>
          </div>
        </div>
      </div>
      ...
      <div class="tour">
        ...
        <div class="ontop">
          ...
          <div id="toAUSButton" onclick="toAustralia()" class="learnMore">
            <p>Learn More</p>
          </div>
        </div>
      </div>
      ...
      <div class="tour">
        ...
        <div class="ontop">
          <h1 style="font-size: 28px; margin-bottom: 8px">NEW ZEALAND</h1>
          <div class="price">From: $1200</div>
          <div id="NZButton" onclick="toNZ()" class="learnMore">
            <p>Learn More</p>
          </div>
        </div>
      </div>
      ...
      <div class="tour">
        ...
        <div class="ontop">
          ...
          <div id="FranceButton" onclick="toFrance()" class="learnMore">
            <p>Learn More</p>
          </div>
        </div>
      </div>
      ...
      <div class="tour">
        ...
        <div class="ontop">
          ...
          <div id="egyptButton" onclick="toEgypt()" class="learnMore">
            <p>Learn More</p>
          </div>
        </div>
      </div>
      ...
      <div class="tour">
        ...
        <div class="ontop">
          ...
          <div id="japanButton" onclick="toJapan()" class="learnMore">
            <p>Learn More</p>
          </div>
        </div>
      </div>
      ...
      <div class="tour">
        ...
        <div class="ontop">
          ...
          <div id="canadaButton" onclick="toCanada()" class="learnMore">
            <p>Learn More</p>
          </div>
        </div>
      </div>
      ...
      <div class="tour">
        ...
        <div class="ontop">
          ...
          <div id="UAEButton" onclick="toUAE()" class="learnMore">
            <p>Learn More</p>
          </div>
        </div>
      </div>
...
`;
      ...
      <div class="contact">
        <div class="map">
          ...
          <div class="map-address">
            <p>
              travel-fly Inc. <br />8901 Marmora Road,<br />
              Glasgow, D04 89GR.<br />
  ...
  var _isrealContent = `<!-------THIS IS THE HEADER------------------->
  <div class="headerTourPages">
  ...
  <!--------DAY NUMBERS + PARAGRAPHS----------->
  <div class="wrapperTourPages">
    <div class="paragraph">
      <div class="title">
        <p>Day #1:</p>
      </div>
  ...
  function initListenersR() {
    $("div .learnMore").click(function(e) {
